...
String.prototype.reverse = function () {   // dentro de prototy de string com uma função de reverse.
...
String.prototype.toString = function () {   // aqui sobrescreve uma função que já tem o to String
    return 'Lascou tudo'
}
